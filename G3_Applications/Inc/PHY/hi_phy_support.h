...
#define PHY_CARRIERS_PER_SUBBAND_CENA    ((uint8_t)   6)   /**< @brief Number of carriers for each subband  CEN-A */
#define PHY_NUM_OF_SUBBANDS_CENA         ((uint8_t)   6)   /**< @brief Number of subbands used for transmission CEN-A */
#define PHY_NUM_OF_CARRIERS_CENA         ((uint8_t)  36)   /**< @brief Number of carriers used for transmission CEN-A */


#define PHY_DEFAULTTONEMAP_CENB          ((uint8_t)0x0F)   /**< @brief Default Value of the Tone Map (all subbands active) CEN-B */
#define PHY_CARRIERS_PER_SUBBAND_CENB    ((uint8_t)   4)   /**< @brief Number of carriers for each subband  CEN-B */
#define PHY_NUM_OF_SUBBANDS_CENB         ((uint8_t)   4)   /**< @brief Number of subbands used for transmission CEN-B */
#define PHY_NUM_OF_CARRIERS_CENB         ((uint8_t)  16)   /**< @brief Number of carriers used for transmission CEN-B */
...
#define PHY_NUM_OF_CARRIERS_FCC          ((uint8_t)  72)   /**< @brief Number of carriers used for transmission CEN-B */
...
typedef struct
{
    ...
    uint8_t mod_type;                     /**< @brief The modulation type (0: ROBO, 1: DBPSK/BPSK, 2: DQPSK/QPSK, 3: D8PSK/8PSK) */
    uint8_t mod_scheme;                   /**< @brief The payload modulation scheme (0: Differential, 1: Coherent) */
    ...
    uint8_t two_rs_block;                        /**< @brief Indication on how many RS blocks have to be used (0: Two RS blocks, 1: One RS block) */
} PHY_ReqParams_t;
...
typedef struct
{
    uint8_t snr_carriers[PHY_NUM_OF_CARRIERS];  /**< @brief The SNR measurements of each carrier */
    uint8_t phase_differential;                 /**< @brief The phase difference in multiples of 60 degrees */
    uint8_t mod_type;                    		/**< @brief The modulation type (0: ROBO, 1: DBPSK, 2: DQPSK, 3: D8PSK) */
    uint8_t mod_scheme;                  		/**< @brief The payload modulation scheme (0: Differential, 1: Coherent) */
    uint8_t tonemap[PHY_TONEMAP_SIZE];     		/**< @brief The Tone map parameter */
    uint8_t dt;                             	/**< @brief The Delimiter type */
    uint8_t two_rs_block;                   	/**< @brief Indication on how many RS blocks have to be used (0: Two RS blocks, 1: One RS block) */
    uint8_t lqi;                            	/**< @brief The Link Quality Indicator */
    uint8_t noise[PHY_NUM_OF_CARRIERS];			/**< @brief Estimation of noise power of subcarrier 0, ..., 71 in dBuV */
    uint8_t signal[PHY_NUM_OF_CARRIERS];		/**< @brief Estimation of signal power of subcarrier 0, ..., 71 in dBuV */
} PHY_IndParams_t;
