...
#define USE_TABLES_FOR_SPEED 	0

#if (USE_TABLES_FOR_SPEED==2)   /* set tables for the normal encryption round */
#  define ENC_ROUND   FOUR_TABLES
#elif (USE_TABLES_FOR_SPEED==1)
#  define ENC_ROUND   ONE_TABLE
#else
#  define ENC_ROUND   NO_TABLES
#endif

#if (USE_TABLES_FOR_SPEED==2)   /* set tables for the last encryption round */
...
#if (USE_TABLES_FOR_SPEED==2)   /* set tables for the normal decryption round */
...
#if (USE_TABLES_FOR_SPEED==2)   /* set tables for the last decryption round */
