/**
 * @file populate_command_list_device.c
...
/* -------------------------------------------------- SINGLE LED OFF ------------------------------------------------- */
void single_led_off_on_rx_cb(uint8_t* data) {
...
/* ------------------------------------------------- SINGLE LED DIM1 ------------------------------------------------ */
void single_led_dim1_on_rx_cb(uint8_t* data) {
...
/* ------------------------------------------------- SINGLE LED DIM2 ------------------------------------------------ */
void single_led_dim2_on_rx_cb(uint8_t* data) {
...
/* ------------------------------------------------- SINGLE LED DIM3 ------------------------------------------------ */
void single_led_dim3_on_rx_cb(uint8_t* data) {
...
/* ------------------------------------------------- SINGLE LED DIM4 ------------------------------------------------ */
void single_led_dim4_on_rx_cb(uint8_t* data) {
...
/* ------------------------------------------------- SINGLE LED ON ------------------------------------------------ */
void single_led_on_on_rx_cb(uint8_t* data) {
    changeDimLevelPwmDutyCycle( LED_DIM_LEVEL_100);
    change_desired_led_current( LUMINARE_MAX_CURRENT );
    ui8_led_on = 1;
}
...
/* ------------------------------------------------- SINGLE LED CUSTOM ------------------------------------------------ */
void single_led_custom_on_rx_cb(uint8_t* data) {
...
/* ------------------------------------------------- ALL LED ON ------------------------------------------------ */
void all_led_on_on_rx_cb(uint8_t* data) {
    changeDimLevelPwmDutyCycle( LED_DIM_LEVEL_100);
    change_desired_led_current( LUMINARE_MAX_CURRENT );
    ui8_led_on = 1;
}
...
/* ------------------------------------------------- ALL LED OFF ------------------------------------------------ */
void all_led_off_on_rx_cb(uint8_t* data) {
    changeDimLevelPwmDutyCycle( LED_DIM_LEVEL_0);
    change_desired_led_current( 0 );
    ui8_led_on = 0;
}
...
/* ------------------------------------------------- ALL LED CUSTOM ------------------------------------------------ */
void all_led_custom_on_rx_cb(uint8_t* data) {
    uint8_t ui8_pwm_duty_cycle = data[0];
    changeDimLevelPwmDutyCycle( LED_DIM_LEVEL_0 - (ui8_pwm_duty_cycle / 100) * LED_DIM_LEVEL_0 );
    change_desired_led_current( (ui8_pwm_duty_cycle / 100) * LUMINARE_MAX_CURRENT );
    if ( ui8_pwm_duty_cycle == 0 ) {
...
/* ------------------------------------------------- ALL LED TOGGLE ------------------------------------------------ */
void all_led_toggle_on_rx_cb(uint8_t* data) {
    if ( ui8_led_on == 0 ) {
        changeDimLevelPwmDutyCycle( LED_DIM_LEVEL_100);
        change_desired_led_current( LUMINARE_MAX_CURRENT );
        ui8_led_on = 1;
